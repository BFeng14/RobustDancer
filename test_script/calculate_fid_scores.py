...
if __name__ == "__main__":
    ...
    real_features = {
        "kinetic": [np.load(os.path.join(extracted_motion_path, f+"_kinetic.npy")) for f in seq_names],
        "manual": [np.load(os.path.join(extracted_motion_path, f+"_manual.npy")) for f in seq_names],
    }
    ...
    for result_file in tqdm.tqdm(result_files):
        ...
        keypoints3d = recover_motion_to_keypoints(result_motion[:, 40:20*20+40], smpl)
